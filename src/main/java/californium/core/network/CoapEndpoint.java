 ...
 ******************************************************************************/
package californium.core.network;
...
import californium.core.network.EndpointManager.ClientMessageDeliverer;
import californium.core.network.config.NetworkConfig;
import californium.core.network.interceptors.MessageInterceptor;
import californium.core.network.serialization.DataParser;
import californium.core.network.serialization.Serializer;
import californium.core.network.stack.BlockwiseLayer;
import californium.core.network.stack.CoapStack;
import californium.core.network.stack.ObserveLayer;
import californium.core.network.stack.ReliabilityLayer;
import californium.core.server.MessageDeliverer;
import californium.elements.Connector;
import californium.elements.MessageCallback;
import californium.elements.CorrelationContext;
import californium.elements.RawData;
import californium.elements.RawDataChannel;
import californium.elements.UDPConnector;

 ...
 *    Kai Hudalla - logging
 ******************************************************************************/
package californium.core.network.serialization;

import static californium.core.coap.CoAP.MessageFormat.CODE_BITS;
import static californium.core.coap.CoAP.MessageFormat.EMPTY_CODE;
import static californium.core.coap.CoAP.MessageFormat.MESSAGE_ID_BITS;
import static californium.core.coap.CoAP.MessageFormat.PAYLOAD_MARKER;
import static californium.core.coap.CoAP.MessageFormat.REQUEST_CODE_LOWER_BOUND;
import static californium.core.coap.CoAP.MessageFormat.REQUEST_CODE_UPPER_BOUND;
import static californium.core.coap.CoAP.MessageFormat.RESPONSE_CODE_LOWER_BOUND;
import static californium.core.coap.CoAP.MessageFormat.RESPONSE_CODE_UPPER_BOUND;
import static californium.core.coap.CoAP.MessageFormat.TOKEN_LENGTH_BITS;
import static californium.core.coap.CoAP.MessageFormat.TYPE_BITS;
import static californium.core.coap.CoAP.MessageFormat.VERSION_BITS;

import californium.core.coap.CoAP;
import californium.core.coap.EmptyMessage;
import californium.core.coap.Message;
import californium.core.coap.Option;
import californium.core.coap.Request;
import californium.core.coap.Response;
import californium.core.coap.CoAP.Code;
import californium.core.coap.CoAP.ResponseCode;
import californium.core.coap.CoAP.Type;

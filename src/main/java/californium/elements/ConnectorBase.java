...
public abstract class ConnectorBase implements Connector {
	 ...
	 * 
	 * @throws Exception any main.java.exceptions that should be properly logged
	 ...
	 * {@link ConnectorBase#receiveNext()}. Therefore, main.java.exceptions do not crash
